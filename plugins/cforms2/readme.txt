...
[Contact Form DB](https://cfdbplugin.com) has support for storing and exporting cformsII's submission data. Therefore cformsII's Tracking Database will be removed in version 15.0. If you have CFDB installed, you will find an export tool at the Tracking DB site. Be sure to enable CFDB's capture submission support for cformsII.
