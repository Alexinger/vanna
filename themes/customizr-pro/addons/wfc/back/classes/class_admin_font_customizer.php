...
class TC_admin_font_customizer {
  ...
  //hook : 'wp_ajax_remove_custom_selector'
  ...
  //hook : 'wp_ajax_register_custom_selector'
  			...
  			array(
  				...
  				'font-style' 	=> array(
  						...
  						'controls' 	=> array(
  								...
  								'font-size' 		=> array(
  									sprintf( '%1$s <span style="font-size:0.85em">%2$s</span>', __('Font size' , $this -> plug_lang ) , __('( in pixels, is converted in flexible em unit for mobile devices )' , $this -> plug_lang ) ),
  									array('tc-number-input',false),
  								),
  								'line-height' 		=> array(
  									sprintf( '%1$s <span style="font-size:0.85em">%2$s</span>', __('Line height' , $this -> plug_lang ) , __('( in pixels, is converted in flexible em unit for mobile devices )' , $this -> plug_lang ) ),
  									array('tc-number-input',false),
  								),
  								'font-weight'   	=> array(
