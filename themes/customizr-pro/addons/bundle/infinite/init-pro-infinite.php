...
final class PC_init_infinite {
      ...
      public function __construct () {
            ...
            //TESTING PURPOSE
            add_filter( 'czr_animate_on', '__return_true' );
      ...
      public function pc_infinite_scroll_class_and_functions() {
            ...
            if ( czr_fn_is_ajax() || $this->pc_is_infinite_scroll_enabled_in_current_context() ) {
                  ...
                  $this->infinite_class = new PC_infinite_scroll();
            }
      ...
      public function pc_register_pro_infinte_settings( $settings ) {
            ...
            $infinite_settings = array(
                  'tc_infinite_scroll'  =>  array(
                        ...
                        'title'     => __( 'Infinite scroll', 'customizr' ),
                        'label'     => __( 'Enable infinite scroll' , 'customizr' ),
                        'section'   => 'post_lists_sec' ,
                        'type'      => 'checkbox' ,
                        'active_callback' => 'czr_fn_is_list_of_posts',
                        'priority'        => 39,
                        'notice'          =>   __( 'When this option is enabled, your posts are revealed when scrolling down, from the most recent to the oldest one, like on a Facebook wall.', 'customizr' ),
                        //temporary hack
                  ...
                  'tc_infinite_scroll_in_home'  =>  array(
                        'default'   => true,
                        'control'   => 'CZR_controls' ,
                        'label'     => __( 'Enable infinite scroll in your home/blog' , 'customizr' ),
                        'section'   => 'post_lists_sec' ,
                        'type'      => 'checkbox' ,
                        'active_callback' => 'czr_fn_is_list_of_posts',
                        'priority'        => 39,
                  ...
                  'tc_infinite_scroll_in_archive'  =>  array(
                        'default'   => false,
                        'control'   => 'CZR_controls' ,
                        'label'     => __( 'Enable infinite scroll in your Archives (archives, categories, author posts)' , 'customizr' ),
                        'section'   => 'post_lists_sec' ,
                        'type'      => 'checkbox' ,
                        'active_callback' => 'czr_fn_is_list_of_posts',
                        'priority'        => 39,
                  ...
                  'tc_infinite_scroll_in_search'  =>  array(
                        'default'   => false,
                        'control'   => 'CZR_controls' ,
                        'label'     => __( 'Enable infinite scroll in your search results' , 'customizr' ),
                        'section'   => 'post_lists_sec' ,
                        'type'      => 'checkbox' ,
                        'active_callback' => 'czr_fn_is_list_of_posts',
                        'priority'        => 39,
      ...
      public function _appearing_animation_css() {
            ...
            <style id="appearing-animation-css" type="text/css">
                  ...
                  */
                  ...
                  .no-cssanimations .grid-container .grid-item .grid__item { opacity: 1;}

                  /*
                  * .start_animation here is "hardcoded",
                  * we might want to have different animations in the future
                  */
                  .grid-container .grid-item .grid__item.start_animation {
                  ...
                  .grid-container .grid-item .grid__item.end_animation {opacity: 1;}
                  ...
                  !( function(czrapp, $){
                        czrapp.ready.done( function() {
                              ...
                              czrapp.$_body.on( 'post-load', function( e, response ) {
                                    if ( 'success' == response.type && response.collection && response.container ) {
                                          centerImagesFN            = czrapp.localized.isModernStyle ? centerInfiniteImagesModernStyle : centerInfiniteImagesClassicStyle;
                                          centerImagesFN(
                                              response.collection,
                                              '#'+response.container //_container
                                          );
                              ...
                              function centerInfiniteImagesClassicStyle( collection, _container ) {
                              ...
                              function centerInfiniteImagesModernStyle( collection, _container ) {
                                    var   $_container                          = $(_container);
