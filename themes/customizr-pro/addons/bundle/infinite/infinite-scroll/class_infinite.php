      ...
      function render( $results ) {
            ...
            */
            ...
            while ( have_posts() ) {
                  ...
                  $before = apply_filters( 'pc_infinite_post_before', '', $template, $results['collection'][ "post-{$_post_id}" ], $results[ 'collection' ] );
                  $after  = apply_filters( 'pc_infinite_post_after', '', $template, $results['collection'][ "post-{$_post_id}" ], $results[ 'collection' ] );
