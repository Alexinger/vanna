...
<div id="footer__credits" class="footer__credits credits" <?php czr_fn_echo('element_attributes') ?>>
  ...
  ?>
    ...
    <span class="fc-wp-powered <?php czr_fn_echo( 'fc_wp_powered_class' )?>">
      <span class="fc-wp-powered-text"><?php _e( 'Powered by', 'customizr' ) ?></span>
      <span class="fc-wp-powered-link"><a class="fa fa-wordpress" href="https://www.wordpress.org" title="<?php _e( 'Powered by WordPress', 'customizr' ) ?>" target="_blank"></a></span>
    </span>
  <?php
