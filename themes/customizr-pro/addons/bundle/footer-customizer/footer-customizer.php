      ...
      function __construct () {
            ...
            */
            ...
            $this -> default_options = array(
              ...
              'fc_copyright_after_text'   => __( 'All rights reserved' , $this -> plug_lang ),
              'fc_site_link_target'       => 0, // 0 = _self, 1 = _blank
              'fc_show_designer_credits'  => 1,
              'fc_credit_text'            => __( 'Designed with' , $this -> plug_lang ),
              'fc_designer_name'          => __( 'Customizr Pro', $this -> plug_lang ),
      ...
      function fc_get_setting_control_map() {
        ...
        $_settings = array(
          ...
          "fc_copyright_after_text" =>  array(
                    ...
                    'control'       => 'CZR_controls' ,
                    'label'         => __( "Copyright text after" , "customizr" ),
                    'section'       => 'footer_customizer_sec' ,
                    'type'          => 'text',
                    'priority'      => 25,
                    'transport'   =>  'postMessage',
