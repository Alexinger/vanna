...
class CZR_post_list_masonry_model_class extends CZR_Model {
    ...
    */
    ...
    function czr_fn_require_masonry_scripts() {
        ...
        wp_enqueue_script(
          'pc-masonry' ,
          TC_GC_BASE_URL . sprintf('/assets/front/js/pc-masonry%1$s.js' ,  ( defined('WP_DEBUG') && true === WP_DEBUG ) ? '' : '.min'),
          array( 'masonry', apply_filters( 'tc_load_concatenated_front_scripts' , ! defined('CZR_DEV')  || ( defined('CZR_DEV') && false == CZR_DEV ) ) ? 'tc-scripts' : 'tc-js-params' ),
