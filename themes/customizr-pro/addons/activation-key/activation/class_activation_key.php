      ...
      ob_start();
        ?>
          <div class="update-nag" style="position:relative;width: calc( 100% - 56px );">
            <h3><?php _e("You did not activate the Customizr Pro theme key yet.", 'edd-theme-updater') ?></h3>
            <p>
              <?php printf('%1$s ( %2$s ) <br/><br/><strong><a class="button-primary" href="%3$s" title="%4$s">%4$s</a></strong>',
                    ...
                    sprintf( '<a href="%1$s" title="%2$s" target="_blank">%2$s</a>', 'http://docs.presscustomizr.com/article/276-why-should-you-keep-your-theme-up-to-date', __( "Why should you keep your Wordpress theme up to date ?", 'edd-theme-updater' ) ),
              ...
              <ol>
                ...
                <li>
                  <?php printf( '%1$s <strong><a href="%2$s" target="_blank">%3$s</a></strong> %4$s',
                              __('Install the theme package manually ( check ' , 'edd-theme-updater' ) ,
                              'http://docs.presscustomizr.com/article/259-pro-installing-customizr-pro-theme',
                              __('this guide', 'edd-theme-updater'),
                              __("if you're not sure how to manually install a theme )", 'edd-theme-updater' )
                        );?>
                </li>
              </ol>
            </p>
    ...
    *******************************************************/
    ...
    function _update_upgrade_transient($license_data) {
      ...
      if ( isset($license_data -> error ) && $license_data -> error  == 'no_activations_left' ) {
        ...
        ?>
          <div class="updated">
            <h3><?php _e("You've reached the limit of activated websites for your current Customizr Pro package.", 'edd-theme-updater') ?></h3>
            <?php
              printf( '<p>%1$s <strong><a href="%2$s" target="_blank">%3$s</a></strong></p>',
                    ...
                    __( "and upgrade your package.", 'edd-theme-updater' )
              );
            ?>
          </div>
        <?php
